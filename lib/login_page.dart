  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Quick Task - Login', style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(168, 220, 246, 1))),
        ...
        child: Column(
          ...
          children: [
            Center(
              ...
              Center(
                child: const Text('Student ID: 2021mt70539',
                    style:
                        TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 42, 42, 42))),
              ),
              SizedBox(
      ...
      backgroundColor: Color.fromARGB(255, 247, 246, 181),
    );
  }
